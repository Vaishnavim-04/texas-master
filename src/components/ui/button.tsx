  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wide",
  {
    variants: {
      variant: {
        ...
        gold: "bg-transparent border border-gold text-gold hover:bg-gold hover:text-primary-foreground rounded-sm",
        hero: "bg-gold text-charcoal font-medium hover:bg-gold-light hover:shadow-lg hover:shadow-gold/20 uppercase tracking-widest rounded-sm",
        elegant: "bg-transparent border-b border-gold/50 text-foreground hover:border-gold hover:text-gold rounded-none px-0",
      },
      size: {
